...
export function HomeView({ data, customers, records, role, session, now, onOpen, onJob, onNew }) {
  ...
  return <div className="page home-page"><div className="home-stack">
    ...
    <div className="home-row home-main-row">
      {/* The panel keeps one name whichever list is showing. It used to
          take the name of the active tab, so choosing Your work left the
          words "Your work" in the header and again in the tab under it,
          and the panel lost the name it had a click earlier. The tabs
          say which list; the header says whose queue it is.

          The count beside the title goes with them for the same reason:
          the active tab already carries it, and the footer carries how
