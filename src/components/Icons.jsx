...
export const IconFilter = (p) => <I {...p}><path d="M3.5 5.5h17l-6.6 7.8v5.4l-3.8 2v-7.4z" /></I>
/* Sort, not group. IconGroup carries a bracket down its left edge —
   rows gathered under a heading — which is the wrong thing to say on a
   register that orders its rows and never groups them. Lines of falling
   length, in the same stroke vocabulary as IconList and IconGroup, with
   the arrow naming the direction. */
export const IconSort = (p) => <I {...p}><line x1="4" y1="6" x2="15" y2="6" /><line x1="4" y1="12" x2="12" y2="12" /><line x1="4" y1="18" x2="9" y2="18" /><polyline points="18 9 18 19 21 16" /><line x1="18" y1="19" x2="15" y2="16" /></I>
export const IconGroup = (p) => <I {...p}><line x1="9" y1="6" x2="21" y2="6" /><line x1="9" y1="12" x2="21" y2="12" /><line x1="9" y1="18" x2="21" y2="18" /><rect x="3" y="4.5" width="3" height="3" rx="0.8" /><rect x="3" y="10.5" width="3" height="3" rx="0.8" /><rect x="3" y="16.5" width="3" height="3" rx="0.8" /></I>
export const IconClose = (p) => <I {...p}><line x1="6" y1="6" x2="18" y2="18" /><line x1="18" y1="6" x2="6" y2="18" /></I>
...
// Brand mark: two concentric open rings cut by a diagonal, from the
// supplied logo. Drawn by hand because it is a specific mark, not a
// glyph any icon set carries.
export const IconBoltz = ({ size = 24, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" aria-hidden="true" {...p}>
    <path d="M18.1 5.6a8.6 8.6 0 1 0 1.0 11.6" />
    <path d="M15.1 9.4a4.3 4.3 0 1 0 0.5 5.4" />
    <line x1="19.8" y1="3.2" x2="5.0" y2="20.8" />
  </svg>
)

/* Light or dark, drawn as the mode you are in. Shared by the rail and
   the top bar so the two controls cannot drift apart. */
export const IconTheme = ({ mode, size = 17 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
